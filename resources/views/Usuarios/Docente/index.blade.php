...
<div class="container" id="app">
    <div class="row justify-content-center">
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header text-uppercase">Docentes</div>
...
@section('modal')
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="modaltitle">Nuevo docente</h5>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col-md-4">
                                ...
                                <input type="text" class="form-control" name="profesion" id="profesion" autocomplete="off">
                            </div>
                        </div>
    ...
    <div class="modal fade" id="delete" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modaltitle">Eliminar docente</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                Eliminar
...
@section('script')
    <script src="{{asset('js/function-docente.js')}}"></script>  
@endsection